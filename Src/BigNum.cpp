 ...
 */
    BigNum
    multiplyMontgomery(const BigNum &left, const BigNum &right, const BigNum &mod, const BigNum &montgomery_coefficient,
                       const BigNum &coefficient) {
        ...
        while (true) {
            ...
            if (x == X) {
                ...
                if (r == 0_bn)
                    ...
                    BigNum r_inverted = inverted(r, mod, BigNum::InversionPolicy::Fermat);
